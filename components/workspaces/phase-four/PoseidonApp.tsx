...
export function PoseidonApp({ product }: { product: Product }) {
  ...
  function confirmTransition() {
    ...
    if (["Ganha", "Perdida"].includes(target)) setActivities((current) => current.filter((activity) => activity.opportunityId !== selected.id || activity.done));
