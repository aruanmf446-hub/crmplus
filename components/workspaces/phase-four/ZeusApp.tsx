...
export function ZeusApp({ product }: { product: Product }) {
  ...
  function addMaintenance() {
    ...
    updateSelected({ maintenance: [record, ...selected.maintenance], odometer, nextMaintenanceKm: odometer + 10000, status: selected.status === "Manutenção" ? "Disponível" : selected.status }, `Manutenção registrada: ${record.type}`);
