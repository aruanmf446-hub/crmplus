...
export const workspaces: Workspace[] = [
  {
    ...
    views: [
      ...
      { id: "clientes", label: "Clientes e veículos", description: "Consulte clientes, veículos atendidos e histórico de serviços.", rows: [{ title: "Mariana Costa", meta: "VW Nivus · QVE 4A21", value: "3 serviços", status: "Ativo" }, { title: "Carlos Souza", meta: "Chevrolet Onix · RTH 8F32", value: "1 serviço", status: "Novo" }, { title: "Barros & Braga", meta: "VW Saveiro · TCJ 9I23", value: "8 serviços", status: "Ativo" }, { title: "Amanda Ribeiro", meta: "VW T-Cross · OSM 2D11", value: "4 serviços", status: "Ativo" }] },
